...
#   aligned - or they will fail with a buserror. That mode is quite
#   known by big-endian machines (sparc, etc) however the alpha cpu is
#   little- endian.
#
#   The following function will test for aligned access to be required
#   and set a config.h define HAVE_ALIGNED_ACCESS_REQUIRED (name
#   derived by standard usage). Structures loaded from a file (or
#   mmapped to memory) should be accessed per-byte in that case to
#   avoid segfault type errors.
#
# LAST MODIFICATION
#
#   2006-08-17
